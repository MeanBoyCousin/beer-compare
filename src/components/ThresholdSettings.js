...
const ThresholdSettings = ({ threshold, setThreshold }) => {
    ...
    return (
        <>
            ...
            {modalVisible && (
                <div className="fixed top-0 left-0 z-30 flex items-center justify-center w-full h-full bg-black-disabled">
                    <div className="modal">
                        <h2 className="text-center text-sm p-2">
                            Use the below settings to specify a threshold for
                            your calories. You will then be warned when you are
                            nearing or over that value.
                        </h2>
                        <Toggle
                            offLabel="Turn on"
                            onLabel="Turn off"
